            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {t("enableMemoryDescription") ||
                  "Allow Kortix to remember information from your conversations"}
              </p>
            </div>
            <Switch
              id="memory-toggle"
              ...
              onCheckedChange={(checked) =>
                updateMemorySettings.mutate(checked)
              }
            ...
            <Alert>
              ...
              <AlertDescription className="text-sm">
                {t("memoryDisabledByUser") ||
                  "Memory is currently disabled. Enable it above to start building memories from your conversations."}
              </AlertDescription>
            </Alert>
          ) : (
            <>
