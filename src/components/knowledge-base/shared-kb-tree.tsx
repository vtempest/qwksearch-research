...
import { useDroppable, DragOverlay, useDraggable } from "@dnd-kit/core";
        ...
        <div>
          ...
          <SpotlightCard
            className={`bg-card border ${
              (isOver && enableDnd) || isDragOverNative
                  ...
                  {enableEdit && editingFolder === item.id ? (
                    <div>
                      <Input
                        ...
                        className={`h-5 text-sm border-0 bg-transparent p-0 focus:ring-1 ${
                          validationError
                            ? "focus:ring-red-500"
                            : "focus:ring-blue-500"
                        }`}
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground truncate">
                        {uploadStatus?.isUploading ? (
                          ...
                          <>
                            {item.data?.entry_count || 0} files • Click to{" "}
          ...
          {item.expanded && (
            <div className="flex flex-col mt-2">
              {isLoadingEntries ? (
                <div
                  className="flex items-center gap-3 px-4 py-4 text-sm text-muted-foreground bg-muted/20 rounded-lg mx-4 mb-2"
                ...
                <div
                  className="flex items-center gap-2 px-4 py-4 text-sm text-muted-foreground bg-muted/10 rounded-lg mx-4 mb-2"
                  style={{ paddingLeft: `${level * 20 + 32}px` }}
                >
        ...
        <div ref={combinedRef} style={style}>
          <SpotlightCard
            className={`bg-card border border-border ${
              itemIsMoving ? "opacity-60 cursor-not-allowed" : ""
                ...
                <div className="flex-1 text-left min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground truncate">
                    {itemIsMoving ? (
                      ...
                      <>
                        {formatFileSize(item.data?.file_size || 0)} • Click to
                        edit summary
                      </>
                    )}
                  </p>
