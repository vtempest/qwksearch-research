...
export function HtmlRenderer({
  ...
  const isAlreadySandboxUrl = useMemo(() => {
    ...
    const isApiEndpoint =
      previewUrl.includes("/sandboxes/") ||
      previewUrl.includes("/files/content");
  ...
  const filePath = useMemo(() => {
    ...
    try {
      ...
      console.error("Error extracting file path from previewUrl:", e, {
        previewUrl,
      });
      return "";
    }
  ...
  const htmlPreviewUrl = useMemo(() => {
    ...
    if (
      ...
      const constructedUrl = constructHtmlPreviewUrl(
        project.sandbox.sandbox_url,
        filePath,
      );
